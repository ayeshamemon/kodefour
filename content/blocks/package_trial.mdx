export const Pricing = ({ ...props }) => (
  <Section py="8|12|16|24" {...props}>
    <Container>
    <p background="black" color="#daa520">If you were looking to find best Umrah Packages you’ve come to the right place. We can get you the best experience you deserve, and we can adjust it according to your budget. 
